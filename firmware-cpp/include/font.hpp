/**
 * HermesLens — TinyUF2 8×13 Bitmap Font
 * =======================================
 * 8 columns × 13 rows, 1 bit per pixel.
 * One row = one byte, MSB = leftmost column.
 * ASCII 32–126 only (95 glyphs).
 * 13 bytes per character.
 * 95 glyphs × 13 bytes = 1,235 bytes total.
 */

#ifndef HERMESLENS_FONT_HPP
#define HERMESLENS_FONT_HPP

#include <cstdint>

static constexpr uint8_t FONT_W     = 8;
static constexpr uint8_t FONT_H     = 13;
static constexpr uint8_t FONT_BYTES = 13;

static const uint8_t TINYUF2[1235] = {
    // 32 ' '
    ...
    // 35 '#'
    0x00,0x24,0x24,0x7E,0x24,0x24,0x24,0x7E,0x24,0x24,0x00,0x00,0x00,
    // 36 '$'
    0x00,0x08,0x3E,0x49,0x48,0x3E,0x09,0x49,0x3E,0x08,0x00,0x00,0x00,
    // 37 '%'
    0x00,0x62,0x64,0x08,0x10,0x20,0x26,0x46,0x00,0x00,0x00,0x00,0x00,
    // 38 '&'
    0x00,0x30,0x48,0x48,0x30,0x32,0x4C,0x44,0x3A,0x00,0x00,0x00,0x00,
    // 39 '''
    ...
    // 42 '*'
    0x00,0x00,0x08,0x49,0x3E,0x1C,0x3E,0x49,0x08,0x00,0x00,0x00,0x00,
    // 43 '+'
    ...
    // 47 '/'
    0x00,0x02,0x04,0x08,0x10,0x20,0x40,0x00,0x00,0x00,0x00,0x00,0x00,
    // 48 '0'
    0x00,0x3C,0x46,0x4A,0x52,0x62,0x42,0x42,0x3C,0x00,0x00,0x00,0x00,
    // 49 '1'
    0x00,0x18,0x28,0x08,0x08,0x08,0x08,0x08,0x3E,0x00,0x00,0x00,0x00,
    // 50 '2'
    ...
    // 53 '5'
    0x00,0x7E,0x40,0x7C,0x02,0x02,0x02,0x44,0x38,0x00,0x00,0x00,0x00,
    // 54 '6'
    0x00,0x1C,0x20,0x40,0x7C,0x42,0x42,0x42,0x3C,0x00,0x00,0x00,0x00,
    // 55 '7'
    0x00,0x7E,0x02,0x04,0x08,0x10,0x20,0x20,0x20,0x00,0x00,0x00,0x00,
    // 56 '8'
    ...
    // 60 '<'
    0x00,0x06,0x18,0x60,0x80,0x60,0x18,0x06,0x00,0x00,0x00,0x00,0x00,
    // 61 '='
    0x00,0x00,0x00,0x00,0x7E,0x00,0x7E,0x00,0x00,0x00,0x00,0x00,0x00,
    // 62 '>'
    0x00,0x60,0x18,0x06,0x01,0x06,0x18,0x60,0x00,0x00,0x00,0x00,0x00,
    // 63 '?'
    0x00,0x3C,0x42,0x02,0x0C,0x18,0x00,0x18,0x18,0x00,0x00,0x00,0x00,
    // 64 '@'
    ...
    // 77 'M'
    0x00,0x42,0x66,0x5A,0x42,0x42,0x42,0x42,0x42,0x00,0x00,0x00,0x00,
    // 78 'N'
    ...
    // 87 'W'
    0x00,0x42,0x42,0x42,0x42,0x5A,0x66,0x42,0x42,0x00,0x00,0x00,0x00,
    // 88 'X'
    ...
    // 91 '['
    0x00,0x3C,0x20,0x20,0x20,0x20,0x20,0x20,0x3C,0x00,0x00,0x00,0x00,
    // 92 '\'
    0x00,0x40,0x20,0x10,0x08,0x04,0x02,0x00,0x00,0x00,0x00,0x00,0x00,
    // 93 ']'
    0x00,0x3C,0x04,0x04,0x04,0x04,0x04,0x04,0x3C,0x00,0x00,0x00,0x00,
    // 94 '^'
    ...
    // 102 'f'
    0x00,0x1C,0x22,0x20,0x7C,0x20,0x20,0x20,0x20,0x00,0x00,0x00,0x00,
    // 103 'g'
    0x00,0x00,0x00,0x3A,0x46,0x42,0x42,0x46,0x3A,0x02,0x02,0x3C,0x00,
    // 104 'h'
    0x00,0x40,0x40,0x5C,0x62,0x42,0x42,0x42,0x42,0x00,0x00,0x00,0x00,
    // 105 'i'
    0x00,0x18,0x00,0x38,0x08,0x08,0x08,0x08,0x3E,0x00,0x00,0x00,0x00,
    // 106 'j'
    0x00,0x0C,0x00,0x1C,0x04,0x04,0x04,0x04,0x04,0x44,0x38,0x00,0x00,
    // 107 'k'
    ...
    // 109 'm'
    0x00,0x00,0x00,0x6C,0x52,0x52,0x52,0x52,0x52,0x00,0x00,0x00,0x00,
    // 110 'n'
    ...
    // 112 'p'
    0x00,0x00,0x00,0x5C,0x62,0x42,0x42,0x62,0x5C,0x40,0x40,0x00,0x00,
    // 113 'q'
    ...
    // 116 't'
    0x00,0x20,0x20,0x7C,0x20,0x20,0x20,0x22,0x1C,0x00,0x00,0x00,0x00,
    // 117 'u'
    0x00,0x00,0x00,0x42,0x42,0x42,0x42,0x46,0x3A,0x00,0x00,0x00,0x00,
    // 118 'v'
    0x00,0x00,0x00,0x42,0x42,0x24,0x24,0x18,0x18,0x00,0x00,0x00,0x00,
    // 119 'w'
    0x00,0x00,0x00,0x52,0x52,0x52,0x52,0x52,0x2C,0x00,0x00,0x00,0x00,
    // 120 'x'
    0x00,0x00,0x00,0x42,0x24,0x18,0x18,0x24,0x42,0x00,0x00,0x00,0x00,
    // 121 'y'
    0x00,0x00,0x00,0x42,0x42,0x42,0x42,0x46,0x3A,0x02,0x04,0x38,0x00,
    // 122 'z'
    ...
    // 125 '}'
    0x00,0x60,0x10,0x10,0x0C,0x10,0x10,0x10,0x60,0x00,0x00,0x00,0x00,
    // 126 '~'
    0x00,0x00,0x00,0x32,0x4C,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
};

#endif  // HERMESLENS_FONT_HPP
